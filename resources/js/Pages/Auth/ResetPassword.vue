        ...
        <div class="hidden lg:flex lg:w-1/2 relative flex-col justify-center px-12 xl:px-16">
            <div class="relative z-10 max-w-lg">
                ...
                <p class="text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
                    Hesabınızın güvenliği için güçlü bir şifre seçin. Yeni şifreniz en az 8 
                    karakter olmalı ve büyük harf, küçük harf, rakam içermelidir.
                </p>
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        ...
                        <span class="text-slate-700 dark:text-slate-300 font-medium">En az 8 karakter uzunluğunda</span>
                    </div>
                    <div class="flex items-center">
                        ...
                        <span class="text-slate-700 dark:text-slate-300 font-medium">Büyük ve küçük harf içermeli</span>
                    </div>
                    <div class="flex items-center">
                        ...
                        <span class="text-slate-700 dark:text-slate-300 font-medium">Rakam ve özel karakter</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="block w-full pl-12 pr-4 py-4 border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 cursor-not-allowed transition-all duration-200"
                            />
                        </div>
