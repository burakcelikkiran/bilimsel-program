...
<template>
    ...
    <div
        class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50 dark:from-slate-900 dark:via-blue-950/20 dark:to-indigo-950/30 flex">
        <!-- Background Elements -->
        <div class="absolute inset-0 overflow-hidden">
            ...
            <div
                class="absolute bottom-1/4 right-1/12 w-96 h-96 bg-indigo-400/6 rounded-full blur-3xl animate-float-delayed">
            </div>
        </div>
        ...
        <div class="hidden lg:flex lg:w-1/2 relative flex-col justify-center px-12 xl:px-16">
            <div class="relative z-10 max-w-lg">
                ...
                <p class="text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
                    Bilimsel etkinliklerin profesyonel yönetimi için tasarlanmış modern platform.
                    Kongrenizi organize etmek hiç bu kadar kolay olmamıştı.
                </p>
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        <div
                            class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-4">
                        ...
                        <span class="text-slate-700 dark:text-slate-300 font-medium">Akıllı program yönetimi</span>
                    </div>
                    <div class="flex items-center">
                        <div
                            class="w-8 h-8 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg flex items-center justify-center mr-4">
                        ...
                        <span class="text-slate-700 dark:text-slate-300 font-medium">Gerçek zamanlı analitik</span>
                    </div>
                    <div class="flex items-center">
                        <div
                            class="w-8 h-8 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center mr-4">
                        ...
                        <span class="text-slate-700 dark:text-slate-300 font-medium">Mobil uyumlu tasarım</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="mx-auto w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-slate-600 dark:text-slate-400">
                        Kongre yönetim panelinize erişim sağlayın
                    </p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between relative z-10">
                        ...
                        <Link v-if="canResetPassword" :href="route('password.request')"
                            class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors underline relative z-10 inline-block">
                        Şifremi unuttum
                        </Link>
                    </div>
