    ...
    <div class="w-full space-y-8">
          ...
          <div class="px-8 py-6 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
            <div class="flex flex-wrap items-center gap-6">
              ...
              <div v-if="form.contact_phone" class="flex items-center space-x-2">
                ...
                <div>
                  <div class="text-sm font-medium text-slate-900 dark:text-white">{{ form.contact_phone }}</div>
                  <div class="text-xs text-slate-500 dark:text-slate-400">Telefon (Önizleme)</div>
                </div>
              </div>
              ...
              <div class="flex items-center space-x-2">
                ...
                <div>
                  <div class="text-sm font-medium text-slate-900 dark:text-white">{{ formatDate(organization.created_at)
                    }}</div>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-4 gap-8">
              ...
              <div class="p-6 space-y-6">
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                      <div
                        class="flex items-center space-x-3 p-4 border border-slate-200 dark:border-slate-600 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                ...
                <div>
                  ...
                  <div class="space-y-6">
                    ...
                    <div v-if="organization.logo_url && !logoPreview && !form._remove_logo"
                      ...
                      <div
                        class="h-20 w-20 rounded-lg overflow-hidden border-2 border-slate-200 dark:border-slate-600 bg-white">
                    ...
                    <div>
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-center w-full">
                          <label
                            class="flex flex-col items-center justify-center w-full h-32 border-2 border-slate-300 border-dashed rounded-lg cursor-pointer bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 dark:border-slate-600 transition-colors">
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ form.name || 'Belirtilmemiş'
                  }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  ...
                  <span class="text-sm text-slate-600 dark:text-slate-400">E-posta</span>
                </div>
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ form.contact_email ||
                  'Belirtilmemiş'
                  }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <PhoneIcon class="h-5 w-5 text-slate-500" />
                  <span class="text-sm text-slate-600 dark:text-slate-400">Telefon</span>
                </div>
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ form.contact_phone ||
                  'Belirtilmemiş'
                  }}</span>
              </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">Mevcut Organizasyon Bilgileri</h3>
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                ...
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ formatDate(organization.created_at)
                  }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ formatDate(organization.updated_at)
                  }}</span>
              </div>
            </div>
          </div>
