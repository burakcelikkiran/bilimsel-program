    ...
    <div class="w-full space-y-8">
      ...
      <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Yeni Organizasyon</h1>
            <p class="text-slate-600 dark:text-slate-400 mt-1">Sistem için yeni bir organizasyon oluşturun</p>
          </div>
          <Link
      ...
      <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        <form @submit.prevent="createOrganization" class="divide-y divide-slate-200 dark:divide-slate-700">
