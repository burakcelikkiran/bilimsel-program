            ...
            <div class="grid grid-cols-1 xl:grid-cols-4 gap-6">
                ...
                <div class="xl:col-span-3 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
                        ...
                        <div class="p-8">
                            <div
                                v-if="presentation.programSession"
                                class="space-y-6"
                            >
                                <!-- Session Title -->
                                <div>
                                ...
                                <div
                                    v-if="
                                        presentation.programSession.start_time
                                    "
                                >
                                    <label
                                        class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1"
                                ...
                                <div
                                    v-if="
                                        presentation.programSession
                                            .categories &&
                                        presentation.programSession.categories
                                            .length > 0
                                    "
                                >
                                    <label
...
const formatTimeRange = (session) => {
    ...
    try {
        ...
        if (!start || !end) return "Zaman belirtilmemiş";
