...
<template>
  ...
  >
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 text-white shadow-lg border border-gray-700">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-gray-300 text-sm">Toplam Sunum</p>
        ...
        <div class="bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-6 text-white shadow-lg border border-gray-600">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold">{{ enhancedStats.with_speakers }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-gray-600 to-gray-700 rounded-xl p-6 text-white shadow-lg border border-gray-500">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-gray-300 text-sm">Konuşmacısız</p>
              <p class="text-2xl font-bold">{{ enhancedStats.without_speakers }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-gray-500 to-gray-600 rounded-xl p-6 text-white shadow-lg border border-gray-400">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold">{{ enhancedStats.keynote }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white dark:bg-gray-900 shadow-xl rounded-2xl overflow-hidden border border-gray-200/50 dark:border-gray-800/50">
      ...
      <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 px-8 py-6 border-b border-gray-200 dark:border-gray-800">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          ...
          <div class="flex items-center space-x-3">
            ...
            <!-- Create Button -->
            <Link
              :href="safeRoute('admin.presentations.create', '/admin/presentations/create')"
      ...
      <!-- List View -->
      <div v-else-if="viewMode === 'list' && displayedPresentations.length > 0" class="overflow-hidden">
        <!-- Bulk Actions -->
        <div 
          ...
          <table class="w-full divide-y divide-gray-200 dark:divide-gray-800">
            <thead class="bg-gray-50 dark:bg-gray-800/50">
              <tr>
                ...
                <!-- Presentation Header -->
                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-all duration-200" @click="handleSort('title')">
                  <div class="flex items-center space-x-1">
                    <span>Sunum</span>
                    <div class="flex flex-col">
                      <ChevronUpIcon class="h-3 w-3 transition-colors duration-200" :class="sortField === 'title' && sortDirection === 'asc' ? 'text-gray-600' : 'text-gray-300'" />
                      <ChevronDownIcon class="h-3 w-3 -mt-1 transition-colors duration-200" :class="sortField === 'title' && sortDirection === 'desc' ? 'text-gray-600' : 'text-gray-300'" />
                    </div>
                  </div>
                </th>
                ...
                <!-- Time Header -->
                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-all duration-200 w-32" @click="handleSort('start_time')">
                  <div class="flex items-center space-x-1">
                    <span>Zaman</span>
                    <div class="flex flex-col">
                      <ChevronUpIcon class="h-3 w-3 transition-colors duration-200" :class="sortField === 'start_time' && sortDirection === 'asc' ? 'text-gray-600' : 'text-gray-300'" />
                      <ChevronDownIcon class="h-3 w-3 -mt-1 transition-colors duration-200" :class="sortField === 'start_time' && sortDirection === 'desc' ? 'text-gray-600' : 'text-gray-300'" />
                    </div>
                  </div>
                </th>
            ...
            <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800">
              ...
              >
                  ...
                  <div class="flex items-start">
                    <div class="flex-shrink-0 h-12 w-12">
                      <div
                        ...
                        :class="getPresentationTypeGradient(presentation.presentation_type)"
                      >
                        <component :is="getPresentationIcon(presentation.presentation_type)" class="h-6 w-6 text-white" />
                      </div>
                    </div>
                    <div class="ml-4">
                      <Link
                        :href="safeRoute('admin.presentations.show', `/admin/presentations/${presentation.id}`, presentation.id)"
                      ...
                      >
                        {{ presentation.title || 'Başlıksız Sunum' }}
                      </Link>
                      <p v-if="presentation.abstract" class="text-gray-600 dark:text-gray-400 mt-1 line-clamp-2 max-w-md">
                        {{ presentation.abstract }}
                      </p>
                      <div class="flex items-center mt-2 text-sm text-gray-500 dark:text-gray-400">
                        <ClockIcon class="h-4 w-4 mr-1" />
                        <span>{{ formatDuration(presentation) }}</span>
                        <span v-if="presentation.language" class="ml-4 px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">
                ...
                <td class="px-6 py-6 w-48">
                  <div class="text-sm">
                    <div class="font-medium text-gray-900 dark:text-white">
                      {{ presentation.program_session?.title || 'Oturum belirtilmemiş' }}
                    </div>
                    <div class="text-gray-500 dark:text-gray-400 flex items-center mt-1">
                      <BuildingOfficeIcon class="h-4 w-4 mr-1" />
                      {{ presentation.program_session?.venue?.display_name || 'Salon belirtilmemiş' }}
                    </div>
                    <div class="text-gray-500 dark:text-gray-400 flex items-center mt-1">
                ...
                <td class="px-6 py-6 w-48">
                  <div class="space-y-1">
                    <div v-if="presentation.speakers && presentation.speakers.length > 0" class="space-y-1">
                      <div
                        v-for="speaker in presentation.speakers.slice(0, 2)"
                        :key="speaker.id"
                        class="flex items-center text-sm"
                      >
                        <div class="flex-shrink-0 h-6 w-6 rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center mr-2">
                          <UserIcon class="h-3 w-3 text-gray-600 dark:text-gray-300" />
                        </div>
                        <span class="text-gray-900 dark:text-white font-medium">
                          {{ speaker.participant?.first_name }} {{ speaker.participant?.last_name }}
                        </span>
                        <span
                          v-if="speaker.pivot?.speaker_role"
                          class="ml-2 px-2 py-1 rounded text-xs"
                          :class="getSpeakerRoleClasses(speaker.pivot?.speaker_role)"
                        >
                          {{ getSpeakerRoleLabel(speaker.pivot?.speaker_role) }}
                        </span>
                      </div>
                      <div v-if="presentation.speakers.length > 2" class="text-xs text-gray-500 dark:text-gray-400">
                        +{{ presentation.speakers.length - 2 }} konuşmacı daha
                      </div>
                    </div>
                    <div v-else class="text-sm text-gray-500 dark:text-gray-400 flex items-center">
                ...
                <td class="px-6 py-6 w-32">
                  <div class="text-sm">
                    <div class="font-medium text-gray-900 dark:text-white">
                      {{ presentation.formatted_time_range || formatTimeRange(presentation) || 'Zaman belirtilmemiş' }}
                    </div>
                ...
                <td class="px-6 py-6 w-60">
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    <Link
                      ...
                      :href="safeRoute('admin.presentations.edit', `/admin/presentations/${presentation.id}/edit`, presentation.id)"
                    ...
                    <div class="relative">
                      <button
                        @click="toggleActionsMenu(presentation.id)"
                      ...
                      <!-- Dropdown Menu -->
                      <div
                        v-if="showActionsMenu === presentation.id"
      ...
      <!-- Grid View -->
      <div v-else-if="viewMode === 'grid' && displayedPresentations.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
        <div
          v-for="presentation in displayedPresentations"
          :key="presentation.id"
        ...
        >
          ...
          <div class="flex items-start justify-between mb-4">
            <div class="flex items-center space-x-3">
              <div
                ...
                :class="getPresentationTypeGradient(presentation.presentation_type)"
              >
                <component :is="getPresentationIcon(presentation.presentation_type)" class="h-5 w-5 text-white" />
              </div>
              <div class="flex-1">
          ...
          <!-- Speakers -->
          <div v-if="presentation.speakers && presentation.speakers.length > 0" class="mt-4">
            <div class="flex flex-wrap gap-1">
              ...
              <span v-if="presentation.speakers.length > 2" class="text-xs text-gray-500 dark:text-gray-400">
      ...
      <div v-else class="py-16">
        <div class="text-center">
          ...
          <h3 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
            {{ searchQuery || hasActiveFilters ? 'Sonuç bulunamadı' : 'Henüz sunum yok' }}
          </h3>
      ...
      <!-- Enhanced Pagination -->
      <div v-if="presentations?.last_page > 1" class="bg-gray-50 dark:bg-gray-800/50 px-8 py-6 border-t border-gray-200 dark:border-gray-800">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <p class="text-sm text-gray-700 dark:text-gray-300">
              <span class="font-medium">{{ presentations.from || 0 }}</span>
              -
              <span class="font-medium">{{ presentations.to || 0 }}</span>
              arası, toplam
              <span class="font-medium">{{ presentations.total || 0 }}</span>
              sonuç
            </p>
          ...
          <nav class="flex items-center space-x-1">
            <!-- Previous -->
            <button
              @click="goToPage(presentations.current_page - 1)"
            ...
            <button
              @click="goToPage(presentations.current_page + 1)"
              :disabled="presentations.current_page >= presentations.last_page"
              class="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700"
            >
              Sonraki
            </button>
...
const enhancedStats = computed(() => {
  const keynoteCount = props.presentations?.data?.filter(p => p.presentation_type === 'keynote').length || 0
...
const isAllSelected = computed(() => {
  return displayedPresentations.value.length > 0 && selectedPresentations.value.length === displayedPresentations.value.length
})

const isIndeterminate = computed(() => {
  return selectedPresentations.value.length > 0 && selectedPresentations.value.length < displayedPresentations.value.length
})
...
const getSpeakerRoleClasses = (role) => {
  const classes = {
    ...
    co_speaker: 'bg-gray-200 text-gray-900 dark:bg-gray-600 dark:text-gray-300',
    discussant: 'bg-gray-300 text-gray-900 dark:bg-gray-500 dark:text-gray-300'
  }
...
const formatEventInfo = (presentation) => {
  ...
  const dayInfo = presentation.program_session?.venue?.event_day?.display_name || ''
...
const formatDuration = (presentation) => {
  ...
  if (!presentation.start_time || !presentation.end_time) return 'Süre belirsiz'
  
  const start = new Date(`2000-01-01 ${presentation.start_time}`)
  const end = new Date(`2000-01-01 ${presentation.end_time}`)
...
const formatTimeRange = (presentation) => {
  ...
  // Simple time formatting - assumes start_time and end_time are in HH:MM format
  const start = presentation.start_time.substring(0, 5) // Get HH:MM part
  const end = presentation.end_time.substring(0, 5) // Get HH:MM part
...
const updateUrl = (params) => {
  ...
  router.get(safeRoute('admin.presentations.index', '/admin/presentations'), {
    ...existingParams,
    ...params,
...
const toggleSelectAll = () => {
  if (isAllSelected.value) {
    ...
    selectedPresentations.value = displayedPresentations.value.map(presentation => presentation.id)
  }
}

const toggleActionsMenu = (presentationId) => {
  showActionsMenu.value = showActionsMenu.value === presentationId ? null : presentationId
}

// Presentation Actions
const duplicatePresentation = (presentation) => {
  showActionsMenu.value = null
  router.post(safeRoute('admin.presentations.duplicate', `/admin/presentations/${presentation.id}/duplicate`, presentation.id), {}, {
    onError: () => {
...
const deletePresentation = (presentation) => {
  ...
  confirmDialog.value = {
    ...
    type: 'danger',
    callback: () => {
      router.delete(safeRoute('admin.presentations.destroy', `/admin/presentations/${presentation.id}`, presentation.id), {
        onSuccess: () => {
...
// Bulk Actions
const bulkDuplicate = () => {
  router.post(safeRoute('admin.presentations.bulk-duplicate', '/admin/presentations/bulk-duplicate'), { 
...
const bulkDelete = () => {
  confirmDialog.value = {
    ...
    type: 'danger',
    callback: () => {
      router.delete(safeRoute('admin.presentations.bulk-destroy', '/admin/presentations/bulk-destroy'), {
