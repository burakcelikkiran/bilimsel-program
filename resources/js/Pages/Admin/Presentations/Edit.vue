          ...
          <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div class="mb-4 lg:mb-0">
              ...
              <p class="text-gray-600 dark:text-gray-400 mt-2">
                "{{ presentation.title }}" sunumunu düzenleyin ve değişikliklerinizi kaydedin
              </p>
            </div>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
              <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">
                  Sunumun başlık, özet ve temel özelliklerini düzenleyin
                </p>
              </div>
              ...
              <div class="p-8 space-y-6">
                ...
                <div>
                  ...
                  <div class="flex justify-between items-center mt-2">
                    <p v-if="form.errors.abstract" class="text-red-500 text-sm">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
              <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">
                  Sunum türü, dil ve süre bilgilerini belirleyin
                </p>
              </div>
          ...
          <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
            ...
            <div class="space-y-3 text-sm">
              <div class="flex justify-between">
                ...
                <span class="text-gray-900 dark:text-white font-medium">#{{ presentation.id }}</span>
              </div>
              
              <div class="flex justify-between">
                <span class="text-gray-500 dark:text-gray-400">Konuşmacı</span>
    ...
    <div v-if="showDeleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-6">
          Bu sunumu silmek istediğinize emin misiniz? Bu işlem geri alınamaz.
        </p>
...
const breadcrumbs = computed(() => [
  ...
  { label: props.presentation.title, href: route('admin.presentations.show', props.presentation.id) },
