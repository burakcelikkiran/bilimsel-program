  ...
  >
    ...
    <div class="w-full space-y-8">
      ...
      <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h3 class="text-xl font-semibold text-slate-900 dark:text-white">{{ event.name }}</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Etkinlik Günleri Yönetimi</p>
              </div>
            </div>
        ...
        <!-- Navigation & Actions -->
        <div class="px-6 py-4 flex flex-wrap items-center justify-between gap-4 bg-white dark:bg-slate-800">
      ...
      <div v-if="eventDays.data.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <div
          ...
          :key="day.id"
          class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-md transition-all duration-200 group"
        >
          <!-- Day Header -->
          <div class="relative">
          ...
          <div class="p-6">
            <div class="flex items-start justify-between mb-4">
              <div class="flex-1">
                <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-1 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                  {{ day.title }}
                </h3>
            ...
            <!-- Description -->
            <p v-if="day.description" class="text-sm text-slate-600 dark:text-slate-400 mb-4 line-clamp-2">
              {{ day.description }}
            </p>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
              <div class="text-center p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                <div class="text-lg font-semibold text-slate-900 dark:text-white">{{ day.program_sessions_count || 0 }}</div>
                <div class="text-xs text-slate-500 dark:text-slate-400">Oturum</div>
              </div>
              <div class="text-center p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                <div class="text-lg font-semibold text-slate-900 dark:text-white">{{ day.presentations_count || 0 }}</div>
                <div class="text-xs text-slate-500 dark:text-slate-400">Sunum</div>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-slate-700">
              <div class="flex items-center space-x-2">
                ...
                <Link
                  ...
                  class="p-2 text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors"
                  title="Görüntüle"
                >
                ...
                <Link
                  ...
                  class="p-2 text-slate-400 hover:text-orange-600 dark:hover:text-orange-400 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-900/50 transition-colors"
                  title="Düzenle"
                >
                ...
                <button
                  ...
                  class="p-2 text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/50 transition-colors"
              ...
              <div class="relative">
                <button
                  ...
                  class="p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                >
                ...
                >
                  <div
                    ...
                    class="absolute right-0 bottom-full mb-2 w-44 bg-white dark:bg-slate-800 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 z-10 border dark:border-slate-700"
                  >
                    <div class="py-1">
                      <button
      ...
      <div v-else class="text-center py-20">
        <div class="mx-auto h-24 w-24 text-slate-400 mb-6">
          <CalendarDaysIcon class="h-full w-full" />
        </div>
        <h3 class="text-xl font-medium text-slate-900 dark:text-slate-100 mb-2">Henüz gün eklenmemiş</h3>
      ...
      <div v-if="eventDays.last_page > 1" class="flex items-center justify-center">
        <nav class="flex items-center space-x-1">
          <button
            ...
            class="p-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
