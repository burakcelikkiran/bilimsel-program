    ...
    <div class="w-full space-y-8">
          ...
          <div class="px-8 py-6 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
            <div class="flex flex-wrap items-center gap-6">
              ...
              <div v-if="form.contact_email" class="flex items-center space-x-2">
                ...
                <div>
                  <div class="text-sm font-medium text-slate-900 dark:text-white">{{ form.contact_email }}</div>
                  <div class="text-xs text-slate-500 dark:text-slate-400">E-posta (Önizleme)</div>
                </div>
              </div>
              ...
              <div v-if="form.website" class="flex items-center space-x-2">
                ...
                <div>
                  <div class="text-sm font-medium text-slate-900 dark:text-white">{{ formatWebsite(form.website) }}</div>
                  <div class="text-xs text-slate-500 dark:text-slate-400">Website (Önizleme)</div>
                </div>
              </div>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-4 gap-8">
        ...
        <div class="xl:col-span-3 space-y-8">
          <!-- Form Card -->
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
            <form id="edit-sponsor-form" @submit.prevent="updateSponsor" class="divide-y divide-slate-200 dark:divide-slate-700">
          ...
          <div class="p-6 space-y-6">
            <div>
              <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">Logo</h3>
              
              <div class="space-y-6">
                <!-- Current Logo -->
                <div v-if="sponsor.logo_url && !logoPreview" class="flex items-center space-x-4">
                  <div class="h-20 w-20 rounded-lg overflow-hidden border-2 border-slate-200 dark:border-slate-600 bg-white">
                    <img :src="sponsor.logo_url" :alt="sponsor.name" class="h-full w-full object-contain p-2" />
                  </div>
                  <div>
                    <p class="text-sm font-medium text-slate-900 dark:text-white">Mevcut Logo</p>
                    <button
                      type="button"
                      @click="removeCurrentLogo"
                      class="inline-flex items-center px-3 py-2 border border-slate-300 text-sm font-medium rounded-md text-slate-700 bg-slate-50 hover:bg-slate-100 focus:ring-2 focus:ring-slate-500 transition-colors mt-2"
                    >
              ...
              <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                >
                  <div class="flex items-center mb-2">
                    <div class="w-8 h-8 bg-slate-100 dark:bg-slate-700 rounded-full flex items-center justify-center mr-3">
                      <StarIcon class="h-5 w-5 text-slate-600 dark:text-slate-300" />
                    </div>
                    <h4 class="font-medium text-slate-900 dark:text-white">Platinum</h4>
                  </div>
                ...
                >
                  <div class="flex items-center mb-2">
                    ...
                    <h4 class="font-medium text-slate-900 dark:text-white">Gold</h4>
                  </div>
                  <p class="text-sm text-slate-500 dark:text-slate-400">
                ...
                >
                  <div class="flex items-center mb-2">
                    <div class="w-8 h-8 bg-slate-100 dark:bg-slate-600 rounded-full flex items-center justify-center mr-3">
                      <StarIcon class="h-5 w-5 text-slate-500 dark:text-slate-400" />
                    </div>
                    <h4 class="font-medium text-slate-900 dark:text-white">Silver</h4>
                  </div>
                  <p class="text-sm text-slate-500 dark:text-slate-400">
                ...
                >
                  <div class="flex items-center mb-2">
                    ...
                    <h4 class="font-medium text-slate-900 dark:text-white">Bronze</h4>
                  </div>
                  <p class="text-sm text-slate-500 dark:text-slate-400">
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">Önizleme</h3>
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ form.name || 'Belirtilmemiş' }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ getSponsorLevelDisplay(form.sponsor_level) }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ sponsor.program_sessions?.length || 0 }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ sponsor.presentations?.length || 0 }}</span>
              </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">Mevcut Sponsor Bilgileri</h3>
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                ...
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ formatDate(sponsor.created_at) }}</span>
              </div>
              
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <ClockIcon class="h-5 w-5 text-slate-500" />
                  <span class="text-sm text-slate-600 dark:text-slate-400">Son Güncelleme</span>
                </div>
                <span class="text-sm font-semibold text-slate-900 dark:text-white">{{ formatDate(sponsor.updated_at) }}</span>
              </div>
            </div>
          </div>
        </div>
