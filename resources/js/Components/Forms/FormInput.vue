...
<template>
    <div class="form-group">
        ...
        <div class="relative">
            ...
            <div
                v-if="rightIcon || (clearable && inputValue)"
        ...
        <!-- Success Message -->
        <p
            v-if="hasSuccess && !hasError && successMessage"
...
const hasSuccess = computed(
    () => Boolean(props.successMessage) || Boolean(props.validation?.valid)
);
...
.form-input:focus {
    box-shadow: 0 0 0 2px rgb(59 130 246 / 0.1), 0 0 0 4px rgb(59 130 246 / 0.1);
}

/* Dark mode enhancements */
.dark .form-input:focus {
    box-shadow: 0 0 0 2px rgb(96 165 250 / 0.2), 0 0 0 4px rgb(96 165 250 / 0.1);
}
